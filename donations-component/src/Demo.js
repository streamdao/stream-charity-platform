...
function DemoComponent(props) {
    ...
    return ( <
        ...
        Box sx = {
            { bgcolor: "#e7ebf0", pt: 4, pb: 4, borderRadius: 2 } } >
        <
        ...
        /Box> {
            selectedOption &&
                ...
                div >
                <
                Alert severity = "info" > Selected donation option: $ { donationDollars }
            to { recipientName } < /Alert> <
            JSONPretty id = "json-pretty"
            data = { selectedOption } > < /JSONPretty> <
                /div>
        } <
        /Stack>
    );
...
function Demo() {
    ...
    return ( <
        ...
        align = "center" > Donation Components Demo < /Typography> <
        Stack spacing = { 2 }
        sx = {
            { pt: 2, pb: 2 } }
        divider = { < Divider / > } >
        <
        DonationComponent merchantPublicKey = "7w18jMeF3TgR6FWcJ1G1P2NJby8MYtH7RArGhP8LfQzU"
        purchaseCents = { 86 }
        setSelectedOption = { setSelectedOption }
        /> <
        JSONPretty id = "json-pretty"
