...
function MerchantPortal(props) {
    ...
    if (loading) {
        ...
        switch (page) {
            case "dashboard":
                pageComponent = < DashboardPage merchantInfo = { merchantInfo }
                setPage = { setPage }
                />;
                pageTitle = "Dashboard";
                break;
    ...
    return ( <
        ...
        DashboardIcon sx = {
            {
                color: page === "dashboard" ?
                    theme.palette.secondary.main : theme.palette.grey[800]
            }
        }
        /> < /
        ListItemIcon > <
        ...
        align = "center" > MERCHANT PORTAL < /Typography> <
        Box sx = {
            {
                display: 'flex',
                alignItems: 'center',
        ...
        <
        WalletDisconnectButton fullWidth variant = "outlined"
        color = "secondary" / >
        <
        /Box> < /
        Drawer >
